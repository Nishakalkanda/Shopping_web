...
from Products.views import add_review, add_to_wishlist, product_api, product_detail, product_detail_api, product_list, wishlist_view
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version='v1',
        description="API Documentation for Django E-Commerce Project",
    ),
    public=True,
